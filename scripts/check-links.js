...
function collectReferences(data) {
  ...
  // The philosopher pages carry their own citation list. Without this line the
  // report checked 90 of this repo's 158 URLs and headed itself "Checked 90
  // reference URL(s)" -- a number that reads as all of them.
